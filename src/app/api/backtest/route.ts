...
async function buildComparison(
  ...
  return {
    ...
    notesAr: [
      ...
      "هامش الأمان = الإصابة الفعلية − الإصابة المطلوبة للتعادل (من متوسطي الربح والخسارة). المقياس الأهم للمتانة: صيغة بعائد/مخاطرة جيد تتعادل بإصابة منخفضة فتحتمل تراجعها، وصيغة تخاطر بأكثر مما تربح تحتاج إصابة عالية هشة تنهار عند أول تغيّر في السوق — معامل ربح مرتفع بهامش أمان ضئيل خدعة.",
      "المنصة تعرض دائماً أهداف/أوقاف الصيغة الهيكلية (عائد/مخاطرة ≥ 1 للهدف الأول و≥ 2 للثاني) — خطة قابلة للتنفيذ بحجم مركز سليم. الكلاسيكية تبقى للمقارنة فقط: قد تسبقها في معامل الربح على أسهم المضاربة الرخيصة (ترتد بسرعة فتُصاب الأهداف القريبة) لكن بهامش أمان أضعف على أسهم الجودة.",
      "خلاصة العينة الكبيرة (الاتجاه الصاعد، 2000+ صفقة): الوقف المتحرك والهجينة أفضل خروج عملي (معامل 1.23، متوسط عائد ~1%) وبأعلى هامش أمان — «اقطع الخسارة بسرعة ودع الربح يجري» يعمل على الجودة لا على القفزات الرخيصة.",
