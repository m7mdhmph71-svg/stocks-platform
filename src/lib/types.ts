...
/**
 * الاستراتيجيات المعتمدة — المُثبَتة بالاختبار التاريخي فقط:
 *   liquidity: صيد السيولة (معامل ربح 1.50، هامش أمان +10)
 *   trend:     الاتجاه الصاعد (2000+ صفقة، معامل 1.18، هامش +4)
 * حُذف «الزخم» (هامش +2 هزيل، سالب بعد التكاليف) و«الاستثمار طويل المدى»
 * (غير قابل للاختبار التاريخي) — يوليو 2026.
 */
export type StrategyKey = "liquidity" | "trend";
